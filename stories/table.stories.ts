...
export const FormTable = () => html`
  <form-table>
    ...
    <form-table-cell col-index="3" row-index="2"><p>Cell</p></form-table-cell>
    <form-table-cell col-index="4" row-index="2"><p>Cell</p></form-table-cell>
    <form-table-cell col-index="1" row-index="3"><p>Cell</p></form-table-cell>
    ...
    <form-table-cell col-index="4" row-index="3" rowspan="2"
